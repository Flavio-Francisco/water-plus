...
import { Button, Container, InputGroup, Form as BootstrapForm } from 'react-bootstrap';
                ...
                >
                    ...
                    <Form>
                        <Image
                            ...
                            width={100}
                            height={100}
                            style={{ borderRadius: 25, marginTop: 5, marginBottom: 30, marginLeft: 110 }}
                        />
                        <h1>Login</h1>
                        ...
                        <BootstrapForm.Group className="mb-3">
                            ...
                            <InputGroup style={{ flexDirection: 'row' }}>
                                ...
                                >
                                    {passwordVisible ? <BsEyeSlash size={25} /> : <BsEye size={25} />}
                                </Button>
                            </InputGroup>
                            <ErrorMessage name="password" component="div" className="error" />
                        </BootstrapForm.Group>
                        <BootstrapForm.Group className="mb-3" controlId="formBasicCheckbox">
                            <Field as={BootstrapForm.Check} type="checkbox" name="rememberMe" label="Lembre-me" />
                        </BootstrapForm.Group>
