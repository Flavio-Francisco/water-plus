...
console.log("produção", data);
        ...
        if (data != null && data.length >= 1) {
            ...
            const poduction:Poduction= {
                permeate: mediaPermeate,
                reject:mediaReject
        }
            console.log("Média de PermeateFlowRate2:", mediaPermeate);
            console.log("Média de RejectFlowRate1:", mediaReject);
